...
Last audit: **2026-04-26** at post-freeze-drain merge — 18 items open, 9 shipped, 1 obsolete. The freeze-week drain shipped 6 PRs (#23-28); D19/D20/D30/D32 fully shipped, D16/D34 partially shipped (first-pass + scope-reframe), D14 marked obsolete (tests fixed mid-sprint-march, no specific commit traceable but the regression is gone), D21 explicitly carried forward as "needs own focused sprint" (8-12 hr, user-facing approval flow). Net code delta on main: -544 LoC across the 6 PRs.
