...
(file:line updated at implementation time; verify with the greps in the PR.)
...
- Output lane: daemon-brief scrub (`src/tools/schedule.zig`, PR #128); detection-only recurrence tap (`src/agent/root.zig` `containsScaffoldSection` at line 2265)
