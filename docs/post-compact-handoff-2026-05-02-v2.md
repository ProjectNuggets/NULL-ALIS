...
- **Main HEAD:** `a6f54b3` (V1.7 cmt9.9 + review fixes — Cyrillic/Greek coverage extended; Zig/SQL convergence PG smoke test added; SQL backfill comment + migration note corrected)
- **104+ commits ahead** of original V1.5 ship-ready handoff (`4d9e16f`)
...
- **V1.6 status:** SHIP-COMPLETE — 16/16 commits + cmt9.5 + ship-gate review fixes (`d50f5d1`); V1.6.1 polish landed in V1.7a-4 (cmt9.9 + review fixes a6f54b3)
...
- **Branch:** `main`
- **Tests:** 5938/5948 PG passed (+18 vs V1.5 baseline; 10 skipped). Only pre-existing `postgres_pool_releases_on_exec_error` baseline failure.
